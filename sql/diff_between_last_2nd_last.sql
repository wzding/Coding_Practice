/*
LAG: 往前数 Returns the value of the Nth row before the current row in a partition.
...
LEAD: 往后数 Returns the value of the Nth row after the current row in a partition.
...
For each user_id, find the time difference between the last action and the second
